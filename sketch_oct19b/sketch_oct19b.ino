...
void loop() {
  ...
  moveServo(back_right.knee, 80,80);
...
void climb(){
  ...
  moveServo(back_left.joint, 100, 20);
  moveServo(back_left.knee, 110, 30);
  moveServo(back_left.joint, 20, 140);
  moveServo(back_left.knee, 30, 110);
  moveServo(back_left.joint, 140,100);
  
  moveServo(fore_right.knee, 100,120);
  moveServo(fore_left.knee, 100, 120);
  
  moveServo(back_right.joint, 110, 170);
  moveServo(back_right.knee, 90, 150);
  moveServo(back_right.joint, 170, 60);
  moveServo(back_right.knee, 150, 90);
